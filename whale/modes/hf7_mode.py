...
# fallback below.
HF7_LEAD_SEARCH_SPAN = (hf_lead.RX_BLOCK_SAMPLES
                        + hf_lead.RX_BLOCK_SAMPLES // hf_lead.BLOCK_SYMBOLS
                        + 2 * HF7_PHY.symbol_len)
...
class Hf7Codec:
    ...
    def decode(self, audio, mode: "Hf7Mode", *, head_seconds=None,
        ...
        for candidate, body_offset in lead_candidates:
            attempt = HF7_PHY.demodulate(
                captured[body_offset:],
                search_span=HF7_LEAD_SEARCH_SPAN, **kwargs)
