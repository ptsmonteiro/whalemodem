...
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | --- | --- |
| fmht0 (experimental) | 800-2,000 Hz | 4-tone noncoherent FSK, 400 Bd | 4 (4-FSK) | 1/3 | terminated K=9 convolutional with 3:2 repetition, interleaved, soft-decision Viterbi | 58 B | 2.520 s | 184.1 bit/s | -4 dB (20/20); not passed at -5 dB (13/20) | not measured |
...
| vfs1 | 468.75-2,437.5 Hz | 64-bin differential BPSK SC-FDE, 1,882 Bd (103 data blocks, 8 pilot blocks) | 2 (DBPSK) | 1/2 | IEEE 802.11n QC-LDPC, interleaved | 389 B | 4.160 s | 748.1 bit/s | 0 dB (20/20); not passed at -1 dB (0/20) | not measured |
...
| vfs2 | 469-2,438 Hz | 64-bin coherent QPSK SC-FDE, 1,882 Bd (122 data blocks, 14 pilot blocks) | 4 (QPSK) | 1/2 | IEEE 802.11n QC-LDPC, interleaved | 956 B | 5.010 s | 1,526.5 bit/s | 0 dB (20/20); not passed at -1 dB (12/20) | RADIOTEST |
| vfs3 | 469-2,438 Hz | 64-bin coherent QPSK SC-FDE, 1,882 Bd (122 data blocks, 14 pilot blocks) | 4 (QPSK) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 1,442 B | 5.010 s | 2,302.6 bit/s | 2 dB (20/20); not passed at 1 dB (14/20) | 2026-09-21, digirig->IC-705 8/8 (SNR not calibrated this session); IC-705->digirig not run, its CAT/PTT would not open |
| fmht4 | 468.75-2,437.5 Hz | 64-carrier 31.25 Hz 8PSK OFDM (56 data, 8 comb pilots), iterative clip-and-filter peak limiting to 9.3 dB PAPR | 8 (8PSK) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 1,745 B | 4.430 s | 3,151.2 bit/s | 2 dB (10/10); not passed at 0 dB (0/10) | not measured |
