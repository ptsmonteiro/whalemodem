...
| fmht4 | 468.75-2,437.5 Hz | 64-carrier 31.25 Hz 8PSK OFDM (56 data, 8 comb pilots), iterative clip-and-filter peak limiting to 9.3 dB PAPR | 8 (8PSK) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 1,745 B | 4.430 s | 3,151.2 bit/s | 2 dB (20/20); not passed at 1 dB (1/20) | 2026-09-22, IC-705->digirig 24/24, digirig->IC-705 14/18 (SNR not calibrated this session; the 4 losses are under-driven or over-clipped cells of a PAPR sweep, not the shipped setting) |
