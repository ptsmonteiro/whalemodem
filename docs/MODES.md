...
| --- | --- | --- | ---: | ---: | --- | ---: | ---: | ---: | --- | --- |
| fmht0 | 800-2,000 Hz | 4-tone noncoherent FSK, 400 Bd | 4 (4-FSK) | 1/3 | terminated K=9 convolutional with 3:2 repetition, interleaved, soft-decision Viterbi | 58 B | 3.170 s | 146.4 bit/s | -4 dB (20/20); not passed at -5 dB (7/20) | 2026-09-21, IC-705->digirig 10/10, digirig->IC-705 10/10 (SNR not calibrated this session) |
...
| vfs1 | 468.75-2,437.5 Hz | 64-bin differential BPSK SC-FDE, 1,882 Bd (103 data blocks, 8 pilot blocks) | 2 (DBPSK) | 1/2 | IEEE 802.11n QC-LDPC, interleaved | 389 B | 4.610 s | 675.1 bit/s | 0 dB (20/20); not passed at -1 dB (0/20) | 2026-09-21, digirig->IC-705 5/5; reverse direction not run (IC-705 CAT port held) |
| vf13 | 600-2,850 Hz | 16-tone combinatorial noncoherent MFSK, 6 of 16 tones per symbol, 150 Bd | 4,096 (of C(16,6)=8,008) | 7/8 | punctured K=7 convolutional, interleaved, soft-decision Viterbi | 1,427 B | 8.483 s | 1,345.7 bit/s | 2 dB (20/20); not passed at 1 dB (2/20) | passed on bench radios; SNR not measured |
| vfs2 | 468.75-2,437.5 Hz | 64-bin coherent QPSK SC-FDE, 1,882 Bd (122 data blocks, 14 pilot blocks) | 4 (QPSK) | 1/2 | IEEE 802.11n QC-LDPC, interleaved | 956 B | 5.460 s | 1,400.7 bit/s | 0 dB (20/20); not passed at -1 dB (12/20) | 2026-09-21, IC-705->digirig 6/6, digirig->IC-705 6/6 (SNR not calibrated this session) |
| vfs3 | 468.75-2,437.5 Hz | 64-bin coherent QPSK SC-FDE, 1,882 Bd (122 data blocks, 14 pilot blocks) | 4 (QPSK) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 1,442 B | 5.460 s | 2,112.8 bit/s | 2 dB (20/20); not passed at 1 dB (14/20) | 2026-09-21, digirig->IC-705 8/8 (SNR not calibrated this session); IC-705->digirig not run, its CAT/PTT would not open |
| fmht4 | 468.75-2,437.5 Hz | 64-carrier 31.25 Hz 8PSK OFDM (56 data, 8 comb pilots), iterative clip-and-filter peak limiting to 9.3 dB PAPR | 8 (8PSK) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 1,563 B | 4.406 s | 2,837.9 bit/s | 2 dB (20/20); not passed at 1 dB (1/20) | 2026-09-22, IC-705->digirig 24/24, digirig->IC-705 14/18 (SNR not calibrated this session; the 4 losses are under-driven or over-clipped cells of a PAPR sweep, not the shipped setting) |
| vf16 | 500-3,000 Hz | 51-carrier 8PSK OFDM (43 data, 8 comb pilots) | 8 (8PSK) | 2/3 | IEEE 802.11n QC-LDPC, interleaved | 1,928 B | 5.047 s | 3,056.1 bit/s | not measured | passed on bench radios; SNR not measured |
| vf12 | 500-3,000 Hz | 51-carrier 16-QAM OFDM (43 data, 8 comb pilots) | 16 (16-QAM) | 3/4 | IEEE 802.11n QC-LDPC, interleaved | 2,839 B | 4.978 s | 4,562.5 bit/s | not measured | passed on bench radios; SNR not measured |
