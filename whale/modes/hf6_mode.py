...
HF6 packages the 64-QAM OFDM configuration from
``experiments.hf10_ofdm49_v6`` into the negotiable waveform contract.  It is
...
from experiments.hf10_ofdm49_v6 import ofdm49_v6 as hf6
