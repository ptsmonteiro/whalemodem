...
| --- | --- | --- | --- |
| HF3 | Passed both declared simulated boundaries: 300/300 benign/static and 291/300 quiet Watterson | Clean retained run was 36/40; all acquired, four failed CRC, so the hardware FER bound failed | **Unresolved.** Retained captures reproduce the failures; do not infer hardware reliability from the simulated gate |
